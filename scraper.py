...
class Scraper:
    ...
    def scrapeMoviePage(self, movie_title, html):
        ...
        soup = BeautifulSoup(html, "html.parser")
        movie_details = soup.find_all("span", class_="itemprop")
        #print("Scraping Movie Page for: " + movie_title)
        return [(details.text.strip().lower(), movie_title) for details in movie_details if details['itemprop'] == "name" or details['itemprop'] == "genre"]
